...
# into a Textpatgen D Template file.
#
...
int main(int argc, char *argv[])
{
  ...
  printf("####################################\n");
  printf("#\n");
  printf("# --- MAKE-D-TPL-0001.D ---\n");
  printf("#\n");
  printf("# This file named %s has\n",argv[1]);
  printf("# been converted to a Textpatgen D\n");
  printf("# Template file.\n");
  printf("#\n");
  printf("####################################\n");
  printf("*/\n\n");
  printf("module make_d_tpl_0001;\n");
  printf("import std.stdio, std.conv, std.string, std.format;\n\n");
  printf("void main(string[] args)\n");
  printf("{\n");
  printf("  writef(\""); /* Open first writef statement */
  ...
  {  
    ...
    else if (c == '\n') /* Newline */
    {
      ...
      printf("  writef(\""); /* Open next writef statement */
    }
